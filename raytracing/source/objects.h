...
{
public:
	virtual bool IntersectRay(const DifRays &ray, HitInfo &hInfo, int hitSide = HIT_FRONT) const;
...
private:
	cyBVHTriMesh bvh;
	bool IntersectTriangle(const DifRays &DifRays, HitInfo &hInfo, int hitSide, unsigned int faceID) const;
	bool TraceBVHNode(const DifRays &DifRays, HitInfo &hInfo, int hitSide, unsigned int nodeID) const;
};
